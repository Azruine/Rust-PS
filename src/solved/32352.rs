...
impl Cuboid
{
    fn new() -> Cuboid
    {
        ...
        Cuboid { x_lo, x_hi, y_lo, y_hi, z_lo, z_hi }
    }
}
fn overlapped_area(a: &Cuboid, b: &Cuboid) -> bool
{
    let x_overlap = std::cmp::max(0, std::cmp::min(a.x_hi, b.x_hi) - std::cmp::max(a.x_lo, b.x_lo));
    let y_overlap = std::cmp::max(0, std::cmp::min(a.y_hi, b.y_hi) - std::cmp::max(a.y_lo, b.y_lo));
